...
public:
    ...
    //空类的sizeof是1字节，加上virtual就变成4个字节了（指针、int）
	virtual void speak()
	{
		cout << "动物在说话" << endl;
	}
...
![image-20210622003140538](C++核心编程.assets/image-20210622003140538.png)
